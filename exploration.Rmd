...
```{r}
knitr::kable(missing_empty_information(collisions), "simple")
```
...
```{r}
knitr::kable(missing_empty_information(involved_persons%>% mutate(accdate = as.Date(accdate))), "simple") 
```
